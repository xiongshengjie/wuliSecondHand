...
/**
 * Servlet implementation class DelCollectionServlet
 */
@WebServlet("/DelCollectionServlet")
public class DelCollectionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(service.delCollection(c)){
			out.write("{\"errCode\":0,\"errMsg\":\"取消收藏成功^_^\"}");
		}else{
			out.write("{\"errCode\":1,\"errMsg\":\"取消收藏失败-_-\"}");
		}
